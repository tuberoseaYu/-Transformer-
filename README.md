...
记录 基于PyTorch 实现 Transformer 的学习笔记。[`5_Transformer.ipynb`](./notes/5_Transformer.ipynb) 从零实现了经典的 Encoder–Decoder Transformer，重点展示各模块的计算逻辑、张量形状以及三类注意力掩码的作用。

![经典 Transformer 架构](./notes/images/transformer/architecture.png)
...
![位置编码公式](./notes/images/transformer/positional-encoding-formula.png)
...
![缩放点积注意力公式](./notes/images/transformer/scaled-dot-product-attention.png)
...
![三类 Mask 在 Transformer 中的位置](./notes/images/transformer/attention-masks.png)
...
![前馈神经网络](./notes/images/transformer/feed-forward-network.png)
...
![Decoder 结构](./notes/images/transformer/decoder-architecture.png)
